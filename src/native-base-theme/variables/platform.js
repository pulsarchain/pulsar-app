...
export default {
  ...
  listItemSelected: '#FF6D6D',

  // List
  listBg: 'transparent',
  // listBorderColor: '#c9c9c9',
  listBorderColor: '#AEAEAE',
  ...
  topTabBarActiveTextColor: '#FF6D6D',
  ...
  topTabBarActiveBorderColor: '#FF6D6D',
  ...
  titleFontSize: platform === 18,
  subTitleFontSize: platform === PLATFORM.IOS ? 11 : 14,
  // subtitleColor: platform === PLATFORM.IOS ? '#8e8e93' : '#FFF',
  subtitleColor: platform === PLATFORM.IOS ? '#666' : '#FFF',
  // titleFontColor: platform === PLATFORM.IOS ? '#000' : '#FFF',
  titleFontColor: platform === PLATFORM.IOS ? '#222' : '#FFF',
